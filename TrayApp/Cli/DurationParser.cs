...
/// outright, neither of which is what someone types when they want a tool to hold something for the length
/// of a build. This reads the compound form instead: a run of number/unit pairs such as <c>1h30m</c>, with a

...
/// Avalonia's platform initialisation, after the tool has already printed that it is running. Checking first
/// lets a headless run fall back to the console instead.
/// </remarks>
